...
<body class="skin-default card-no-border bg-1">
    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">User Login</p>
        </div>
    </div>
    <!-- ============================================================== -->
            ...
            <div class="login-box card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('login') }}" enctype="multipart/form-data">
                        ...
                        @csrf
                        {{-- <h5 class="text-center m-b-20"> Login</h5> --}}

                        <div class="form-group ">
                            <div class="col-xs-12">
                                <label for="email" value="{{ __('Email') }}" class="py-2">Email</label>
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                <label for="password" value="{{ __('Password') }}" class="py-2">Password</label>
